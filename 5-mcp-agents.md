...
> [!TIP]
> An MCP Server can be implemented in any language, I like these examples with [http4k/kotlin](https://mcp.http4k.org) which can be seamlessly integrated with Java ecosystem.
